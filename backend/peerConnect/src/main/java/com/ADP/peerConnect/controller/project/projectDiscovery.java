...
@RestController
@RequestMapping("/api/projectDiscovery")
public class projectDiscovery {
    ...
    public ResponseEntity<PagedResponse<ProjectCardResponse>> discoverProjects(
        ...
        Page<ProjectCardResponse> projectPage =
                projectService.discoverProjects(currentUser.getId(), pageable);
    ...
    @Operation(summary = "Get projects in College",
            description = "Get a paginated list of projects associated with a specific college ID.")
    ...
    public ResponseEntity<PagedResponse<ProjectCardResponse>> getProjectsInCollege(
        ...
        Pageable pageable = PageRequest.of(page, size);
        Page<ProjectCardResponse> projects =
                projectService.findProjetsInCollege(collegeId, pageable);
    ...
    @Operation(summary = "Search projects",
            description = "use project status only RECRUITING, IN_PROGRESS, COMPLETED, CANCELLED")
    ...
    public ResponseEntity<PagedResponse<ProjectCardResponse>> searchProjects(
        ...
        Page<ProjectCardResponse> projects =
                projectService.searchProjects(query, category, status, skills, availableOnly, pageable, currentUserId);
