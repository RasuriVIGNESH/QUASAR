...
public class TeamController {
        ...
        public ResponseEntity<ApiResponse<ProjectInvitationResponse>> inviteUserToProject(
                ...
                ProjectInvitationResponse response = teamService.inviteUserToProject(
        ...
        public ResponseEntity<ApiResponse<ProjectInvitationResponse>> respondToInvitation(
                ...
                ProjectInvitationResponse invitationResponse = teamService.respondToInvitation(invitationId, response,
                                currentUser.getId());
        ...
        public ResponseEntity<PagedResponse<ProjectInvitationResponse>> getProjectInvitations(
                ...
                Page<ProjectInvitationResponse> page =
                        projectInvitationService.getProjectInvitations(
                                projectId,
                                userId,
                                pageable
                        );

                PagedResponse<ProjectInvitationResponse> response =
                        new PagedResponse<>(
                                page.getContent(),
                                page.getNumber(),
                                page.getSize(),
        ...
        public ResponseEntity<ApiResponse<ProjectMemberResponse>> updateMemberRole(
                ...
                ProjectMemberResponse memberResponse = teamService.updateMemberRole(projectId, memberId, role, currentUser.getId());
