...
public interface ProjectMemberRepository extends JpaRepository<ProjectMember, Long> {
    ...
    @Query("SELECT pm FROM ProjectMember pm JOIN FETCH pm.user WHERE pm.project.id = :projectId ORDER BY pm.createdAt ASC")
    List<ProjectMember> findByProject_IdOrderByCreatedAtAsc(@Param("projectId") String projectId);
