...
public class TeamService implements iTeamService {
     ...
     */
    public ProjectInvitationResponse inviteUserToProject(String projectId, String invitedUserId,
        ...
        return new ProjectInvitationResponse(savedInvitation);
    }

    /**
     * Respond to project invitation
     */
    public ProjectInvitationResponse respondToInvitation(Long invitationId, InvitationStatus response, String userId) {
     ...
     * Update member role
     */
    public ProjectMemberResponse updateMemberRole(String projectId, String memberId, ProjectRole newRole, String requesterId) {
        // Check if requester is project Lead
        if (!projectService.isProjectLead(projectId, requesterId)) {
        ...
        return new ProjectMemberResponse(savedMember.getId(), savedMember.getCreatedAt(), savedMember.getProjectRole(), new com.ADP.peerConnect.model.dto.response.UserResponse(savedMember.getUser()));
    }
    ...
    public List<ProjectMemberResponse> getProjectMembers(String projectId, String currentUserId) {
        ...
        return members.stream()
                .map(member -> new ProjectMemberResponse(member.getId(), member.getCreatedAt(), member.getProjectRole(), new com.ADP.peerConnect.model.dto.response.UserResponse(member.getUser())))
