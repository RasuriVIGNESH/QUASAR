...
public class ChatController {
    ...
    // @Operation(summary = "Search messages", description = "Search messages by
    // content")
    // @ApiResponses(value = {
    ...
    // description = "Must be project member")
    // })
    // public ResponseEntity<ApiResponse<PagedResponse<ChatMessageResponse>>>
    // searchMessages(
    // @Parameter(description = "Project ID") @PathVariable String projectId,
    // @Parameter(description = "Search query") @RequestParam String query,
    // @Parameter(description = "Page number (0-based)") @RequestParam(defaultValue
    // = "0") int page,
    // @Parameter(description = "Page size") @RequestParam(defaultValue = "20") int
    // size,
    // @Parameter(hidden = true) @AuthenticationPrincipal UserPrincipal currentUser)
    // {
    //
    ...
    // Page<ChatMessage> messages = chatService.searchMessages(projectId, query,
    ...
    // messages.getTotalElements(), messages.getTotalPages());
    //
    // ApiResponse<PagedResponse<ChatMessageResponse>> response =
    // ApiResponse.success(
    // "Messages retrieved successfully", pagedResponse);
    //
    // return ResponseEntity.ok(response);
    ...
    public ResponseEntity<ApiResponse<List<ChatMessageResponse>>> getMessagesAfter(
            @Parameter(description = "Project ID") @PathVariable String projectId,
            @Parameter(description = "Get messages after this time") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime after,
            @Parameter(hidden = true) @AuthenticationPrincipal UserPrincipal currentUser) {
    ...
    // @Operation(summary = "Get latest message", description = "Get the latest
    // message in project")
    // @ApiResponses(value = {
    // @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200",
    ...
    // {
    //
    // ChatMessage message = chatService.getLatestMessage(projectId,
    // currentUser.getId());
    //
    // if (message == null) {
    // ApiResponse<ChatMessageResponse> response = ApiResponse.success(
    ...
    // }
    //
    // ChatMessageResponse messageResponse = modelMapper.map(message,
