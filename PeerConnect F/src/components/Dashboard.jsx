                  ...
                  {showMenu && (
                    ...
                    >
                      <button
                        ...
                        className="w-full px-4 py-3 text-left hover:bg-indigo-50 dark:hover:bg-slate-800 flex items-center justify-between transition-colors"
                      >
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <motion.button
                ...
                className="px-8 py-4 bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 rounded-2xl font-bold hover:border-indigo-200 hover:bg-indigo-50 dark:hover:bg-slate-800 transition-all flex items-center gap-2"
              >
